...
name: webapp-testing
description: >
  This skill should be used when the user wants to test or interact with a local web application
...
Always call `page.wait_for_load_state('networkidle')` before inspection.
...
To install Playwright (run once on vibecode):
```bash
